...
L'**MBE** è una tecnica di crescita epitassiale in cui film sublimati crescono in modo monocristallino in condizioni di ultra-alto vuoto (UHV, P ≤ 10⁻⁹ Torr). Si distingue tra:
...
La qualità dipende dal **mismatch reticolare**: materiali con costanti di reticolo simili formano interfacce di alta qualità. Esempi:
- GaAs/AlAs
- AlP/GaP
- AlSb/GaSb
