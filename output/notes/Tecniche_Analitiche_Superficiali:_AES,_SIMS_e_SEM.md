...
L'AES si basa sul **processo Auger**, un meccanismo di de-eccitazione atomica a tre elettroni:
...
- Combinata con sputtering ionico, consente la **profilazione in profondità**
...
La SIMS utilizza un fascio di ioni primari per bombardare la superficie del campione in camera UHV. Il processo di sputtering rimuove atomi superficiali (come neutri o ioni secondari), che vengono analizzati da uno **Spettrometro di Massa a Quadrupolo (QMS)**.
...
Un fascio di elettroni primari (energia E₀) viene scansionato sulla superficie del campione. L'intensità degli elettroni emessi modula l'intensità di un tubo TV, formando un'immagine.
...
I SEM standard operano in alto vuoto (~10⁻⁵ Pa). Sono stati sviluppati **SEM in condizioni UHV**, collegabili tramite camere load-lock ad altre apparecchiature UHV, permettendo indagini **in situ** dopo la preparazione superficiale senza esposizione all'aria.