...
Lo STM e l'Atomic Force Microscope (AFM) correlato hanno aperto la strada alla [[Microscopia a Effetto Tunnel (STM) e Nanotecnologia|nanotecnologia]] vera e propria, consentendo di passare dall'osservazione alla manipolazione diretta della materia a scala atomica.
...
Eigler e Schweizer (1990) hanno dimostrato la manipolazione controllata di singoli atomi di Xe su Ni(110) a bassa temperatura in [[Tecnologia dell'Ultravuoto (UHV) e Misura della Pressione|Ultra-High Vacuum]], sviluppando due tecniche complementari:
