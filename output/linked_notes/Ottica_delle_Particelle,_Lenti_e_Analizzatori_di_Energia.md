...
Lo spettrometro per [[High-Resolution Electron Energy Loss Spectroscopy (HREELS)|High-Resolution Electron Energy Loss Spectroscopy]] (HREELS) è un sistema integrato composto da:
...
Il CMA è particolarmente diffuso in [[Spettroscopia Auger (AES)|Spettroscopia Auger]] (AES). Esiste anche una versione a **doppio stadio** (double CMA) per migliori prestazioni.