...
La tecnica [[SEXAFS: Struttura Superficiale tramite Assorbimento X|SEXAFS]] (Surface Extended X-Ray Absorption Fine Structure) è basata sull'analisi delle oscillazioni del coefficiente di assorbimento X in funzione dell'energia dei fotoni, al di sopra della soglia di assorbimento. Il coefficiente di assorbimento può essere espresso come:
...
- **Emissione di [[Tecniche Analitiche Superficiali: AES, SIMS e SEM|elettroni Auger]]** (metodo SEXAFS)
...
Studio SEXAFS dell'adsorbimento di zolfo su Ni(100) con struttura c(2×2) determinata da [[Reticoli 2D, Sovrastrutture e Spazio Reciproco|LEED]]:
